...
citation:
  doi: "10.5281/zenodo.10690829"
  url: https://davetayl-r.github.io/youth-employment-nma-paper/youth-employment-nma-supplementary-material.html
...
This page contains supplementary material for a network meta-analysis titled <i>"Employment and skills interventions designed to assist young people to enter the labour market in high income countries: A component network meta-analysis"</i>.
...
-   <b>Extraction and transformation of information from relevant studies</b> --- this section contains information on:
...
-   <b>Supplementary information about included and excluded studies</b> --- this section contains information on:
...
### @apunyo2022interventionsincreaseyouth EGM
...
### @youthemploymentegm2017 EGM

All studies included in the following 'interventions' were screened for inclusion:
...
### @kluveInterventionsImproveLabour2017 Systematic Review

All studies included in this review were screened for inclusion.
...
Fifty-eight (n=58) studies — reported in 73 articles — met our inclusion criteria and were included in this review. Of these:

-   Thirty-five (n=35) papers were different reports of other included studies, studies reported in multiple papers were treated as a single study for the purposes of this review. For studies reported in multiple papers, a primary study was selected to serve as the primary reference.

-   Eight (n=8) papers reported analyses of one or more different programs, which were treated as separate studies [@bloomNationalJTPAStudy1993; @caliendo2011fightingyouthunemployment; @davisRethinkingBenefitsYouth2017; @frakerThreeYearEffectsYouth2018; @hollenbeckNetImpactEstimates2006; @hollenbeckNetImpactBenefitCost2016; @maibom2014canactivelabour; @nadonMakingTransitionHow2020]

-   Three (n=3) programmes were evaluated at two time points, 10 years apart, involving different populations and were treated as separate studies [@hollenbeckNetImpactEstimates2006; @hollenbeckNetImpactBenefitCost2016].

+--------------------------------------------------------------------------------------------------------+-------------------------------------------------+-------------------------------------------+
| Intervention name                                                                                      | Primary reference                               | Secondary reference(s)                    |
+========================================================================================================+=================================================+===========================================+
| Independent living programs                                                                            | @kimEstimatingEffectsIndependent2019            | @nadonMakingTransitionHow2020             |
+--------------------------------------------------------------------------------------------------------+-------------------------------------------------+-------------------------------------------+
...
Sixty-eight (n=68) studies were excluded during full-text screening. A selection of these studies and the reasons for their exclusion are detailed in @tbl-ye-nma-full-text-reject.

### Included studies not included in NMA

Of the fifty-eight (n=58) included studies, five (n=5) were not included in a network meta-analysis for either employment status or education completion. They were:

-   A study by @strombackEarningsSchoolingVocational2010 only reported wage outcomes,

-   A study by @feinBridgingOpportunityDivide2018 only reported wage outcomes, and

-   A study by @jastrzabImpactsServiceFinal1996\] did not report sufficient information to allow for the transformation of results to a common effect size.
...
## Details of results that we were unable to convert to an effect size
...
#| echo: false
#| message: false
#| name: nma-employment-status-standard-cnma
#| fig-cap: Forest plot depicting results of a standard CNMA for employment status
#| fig-width: 12
#| fig-height: 4
#| label: fig-nma-employment-status-standard-cnma
#| cache: true
...
#| fig-cap: Forest plot depicting results of CNMA with interaction between Basic Skills Training x Off-the-Job Training for employment status
#| fig-width: 8
#| fig-height: 2.5
...
component_labels <- c(
  ...
  "On-the-Job Training", 
  "Other", 
  "Basic Skills Training x Off-the-Job Training"
  )
...
#| fig-cap: Forest plot depicting results of CNMA with interaction between Basic Skills Training x Other for employment status
#| fig-width: 7
#| fig-height: 2.5
...
#| fig-cap: Forest plot depicting results of CNMA with interaction between Life Skills Training x Other for employment status
#| fig-width: 7
#| fig-height: 2.5
...
#| fig-cap: Forest plot depicting results of CNMA with interaction between Coaching and Mentoring x Other for employment status
#| fig-width: 7
#| fig-height: 2.5
...
component_labels <- c(
  ...
  "On-the-Job Training", 
  "Other", 
  "Coaching and Mentoring x Other"
  )
...
#| fig-cap: Forest plot depicting results of Interaction, Additive and standard CNMA of component combinations on employment status
#| fig-width: 8
#| fig-height: 22
...
employment_forest_plot_data <- netbind(
  ...
  name = c(
    "Standard CNMA", 
    "Additive CNMA", 
    "Basic Skills Training x Off-the-Job Training Interaction CNMA",
    "On-the-Job Training x Other Interaction CNMA",
    "Basic Skills Training x Other Interaction CNMA",
    "Life Skills Training x Other Interaction CNMA",
    "Coaching and Mentoring x Other Interaction CNMA"
    ), 
...
::: custom-footnote
**Plot Legend:**\
*APP:* Apprenticeships, *BS:* Basic Skills Training, *LS:* Life Skills Training, *OFF-JT:* Off-the-Job Training, *ON-JT:* On-the-job-training, *C&M:* Coaching and Mentoring, *OTH:* Other (residual) component.
:::
...
-   Life Skills Training + Coaching and Mentoring + Other versus Services as Usual (I^2^: 98%)
...
#| echo: false
#| message: false
#| name: nma-education-completion-standard-cnma
#| fig-cap: Forest plot depicting results of a standard CNMA for education completion
#| fig-width: 10
#| fig-height: 4
#| label: fig-nma-education-completion-standard-cnma
#| cache: true
...
::: custom-footnote
**Plot Legend:**\
*BS:* Basic Skills Training, *LS:* Life Skills Training, *OFF-JT:* Off-the-Job Training, *ON-JT:* On-the-job-training, *C&M:* Coaching and Mentoring, *OTH:* Other (residual) component.
:::
...
#| fig-cap: Forest plot depicting results of CNMA with interaction between Life Skills Training x Other for education completion
#| fig-width: 7
#| fig-height: 2.5
...
#| fig-cap: Forest plot depicting results of CNMA with interaction between Coaching and Mentoring x Other for education completion
#| fig-width: 7
#| fig-height: 2.5
...
#| fig-cap: Forest plot depicting results of Interaction, Additive and standard CNMA of component combinations on education completion
#| fig-width: 7
#| fig-height: 14
...
The PRISMA 2020 checklist is included in @tbl-nma-prisma-checklist.

```{r}
#| echo: false
#| tbl-cap: PRISMA 2020 Checklist Updated
#| name: nma-supplementary-material-prisma-2020
#| label: tbl-nma-prisma-checklist
